...
var levelsRaw = {
  ...
  '14-1': [0.667, 1.667, 1.667, 3, 2.933],
  '14-2': [0.667, -3, -3.333, -0.667, 0.667],
  '14-3': [-1.667, 3.333, 1, 3.333, -0.667],
  '14-4': [-2.333, 1, -2.933, 1, -0.667],
  '14-5': [-0.667, 0.667, 3, -3, 2.667],
  '14-6': [-2, 2.667, -1.533, 0.8, -0.333],
  '14-7': [-1.667, 2.933, 3.333, -1.333, -0.667],
  '14-8': [-2.267, -1.333, -2.267, 0.667, 0.667],
  '14-9': [2.4, 1.333, -1.333, 1.333, -3.333],
  '14-支1': [3.133, 1.667, 2.333, 1, 0.8],
  '14-支2': [2.933, -2.267, -2.933, 1.333, -0.667],
  '14-支3': [0.667, 1.333, -0.667, 1.6, -2.533],
};
 ...
 */
 var levelBonus = {
  ...
  '14-2': [addBonusInfo('A', 1, '欧式古典')],
  '14-3': [addBonusInfo('A', 1, '中式古典')],
  '14-4': [addBonusInfo('A', 1, '波西米亚')],
  '14-5': [addBonusInfo('A', 1, '小动物')],
  '14-6': [addBonusInfo('A', 1, '洛丽塔')],
  '14-8': [addBonusInfo('A', 1, '波西米亚')],
  '14-9': [addBonusInfo('A', 1, '冬装')],
  '14-支1': [addBonusInfo('A', 1, '波西米亚')],
  '14-支3': [addBonusInfo('A', 1, '睡衣')],
